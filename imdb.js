...
function handleButtonClick(event) {
    ...
    // Check if the clicked element has class "btn_1" or "btn_2"
    if (target.classList.contains('btn_1')) {
        showAlertMessage('You added to watchlist!');
    } else if (target.classList.contains('btn_2')) {
        showAlertMessage('You add it to your fevorites movie!');
    }
}

// Function to display the alert popup message
